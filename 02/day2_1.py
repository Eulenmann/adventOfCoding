    ...
    with open(filename, 'r') as file:
        ...
        for range_str in ranges:
            ...
            for number in number_range:
                ...
                check_if_even_and_left_equals_right(num_length,num_str,number)
    return solution

def check_if_even_and_left_equals_right(num_length,num_str,number):
    global solution
    if num_length % 2 == 0:
...
# Beispielaufruf
final_solution = process_and_handle_ranges("input.txt")
print(f"Die finale Lösung ist: {final_solution}")